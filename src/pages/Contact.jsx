...
function Contact () {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
          .send(import.meta.env.REACT_APP_SERVICE_ID, import.meta.env.REACT_APP_TEMPLATE_ID, templateParams, {
    ...
    return (
        <div className="flex flex-col items-center w-full">
            ...
            <div className="flex flex-col sm:flex-row items-start md:items-center w-full">
                <div className="flex flex-col items-center justify-evenly bg-[#FFFFFC] p-5 w-full h-full">
                ...
                <div className="flex flex-col items-center justify-center bg-[#ebc694] p-5 w-full">
                    <h2 className="text-[1.2rem] font-bold tracking-wider">HAVE A QUESTION?</h2>
                    <h4 className="text-xs w-1/2 text-center text-wrap px-6 mb-3">FILL OUT THE FORM BELOW & WE'LL GET BACK TO YOU!</h4>
                    <form className="flex flex-col items-start justify-center" autoComplete="off" onSubmit={sendEmail}>
