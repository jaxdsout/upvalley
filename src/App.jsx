...
import header from "./assets/455a9d0f85df81fcf8dc65019d274e4d.jpg"
import header2 from "./assets/a8472ad2b5b3598dd3b576abff796d7b.jpg"
import header3 from "./assets/eea55edc3749f89aa2c23cf508e55615.jpg"

const backgrounds = [header, header2, header3];
        ...
        <div className='flex flex-col items-start justify-start h-screen'>
          {/* <div className="relative w-full">
            {backgrounds.map((bg, i) => (
              <img
                ...
                src={bg}
                alt={`Header ${i}`}
                className="fade-slide absolute max-h-[500px] min-h-[350px] w-full object-cover"
                style={{
                  animationDelay: `${(i * 9) / backgrounds.length}s`,
                  zIndex: backgrounds.length - i,
                }}
              />
            ))}
          </div> */}
          <div className="flex flex-col items-center justify-center">
            <div className="w-3/4 text-center mt-8 mb-8">
          ...
          <div className='flex flex-col items-center justify-center w-full bg-[#242424] text-white py-5 shadow-inset'>
            ...
            <div className="mt-10 mb-5">
              <p className="text-xs">UpValley Electric Inc. 2025</p>
            </div>
          </div>
        </div>
      )}
